...
#alias grub-update='sudo grub-install --boot-directory=/boot --efi-directory=/boot/efi --target=x86_64-efi --bootloader-id=Linux && sudo grub-mkconfig -o /boot/grub/grub.cfg'
